    ...
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>
            By accessing or using devmarket ("the Platform"), you agree to be bound by these Terms of Use. If you do not agree, please do not use the Platform.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>To impersonate or attempt to impersonate devmarket, a devmarket employee, or any other person.</li>
        ...
        <section>
          ...
          <p>
            When you create an account, you must provide accurate and complete information. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. Notify us immediately of any unauthorised use.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            All purchases are processed securely through our payment provider. Prices are listed in the currency shown at checkout. By completing a purchase, you agree to pay the listed price. All sales are subject to our Return Policy.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            All content on the Platform, including but not limited to text, graphics, logos, and digital products, is the property of devmarket or its content suppliers and is protected by applicable intellectual property laws. You may not reproduce, distribute, or create derivative works without express written permission.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            To the fullest extent permitted by law, devmarket shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of the Platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We reserve the right to modify these Terms at any time. Changes will be effective immediately upon posting. Your continued use of the Platform after changes are posted constitutes your acceptance of the revised Terms.
          </p>
        </section>
