      ...
      <div className="space-y-8 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>Purchase and transaction data</li>
            <li>Communications you send us</li>
          </ul>
          <p className="mt-2">
            We also automatically collect certain information when you use the Platform, such as IP address, browser type, pages visited, and referring URLs.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-2">3. Sharing of Information</h2>
          <p>
            We do not sell, trade, or rent your personal information to third parties. We may share your information with:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Payment processors to complete transactions</li>
            <li>Service providers who assist in our operations (e.g., email delivery, cloud storage)</li>
        ...
        <section>
          ...
          <p>
            We implement reasonable technical and organisational measures to protect your information against unauthorised access, alteration, disclosure, or destruction. However, no method of transmission over the internet is 100% secure.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use cookies and similar tracking technologies to track activity on the Platform and hold certain information. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent.
          </p>
        </section>
